...
export default function ConfigureReportIr() {
     // breadcrumb
     const breadcrumb = [
        {
            path: "#!",
        ...
        {
            path: `${adminRouteMap.REPORTGENERATORIR.path}`,
        ...
        <>
            ...
            <div className="pageContent configureReport">
                <div className="pageTitle d-flex align-items-center">
                    <Link aria-label='Back icon' to={adminRouteMap.REPORTGENERATORIR.path} className='backLink'><em className='icon-back'></em></Link>
