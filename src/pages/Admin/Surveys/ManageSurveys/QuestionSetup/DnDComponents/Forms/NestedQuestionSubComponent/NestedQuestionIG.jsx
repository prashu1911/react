...
export default function NestedQuestionIG({
  setActiveForm,
  outcome,
  surveyType,
  surveyID,
  ...
  const getInitialValues = useMemo(() => {
    ...
    return {
      ...
      type: initialQuestionData.selectionType || "Single Select",
      ...
      randomizeQuestions: initialQuestionData.isRandom || false,
    ...
    <>
      <Form onSubmit={formik.handleSubmit}>
        ...
        <div className="d-flex justify-content-end gap-2">
          ...
          <Button variant="primary" className="ripple-effect" type="submit">
