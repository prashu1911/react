...
const SingleRatingJumpQuestionDA = ({
  ...
  const formik = useFormik({
    ...
    validationSchema: SingleRatingGateQulifierQuestionValidationSchema(rangeStart,rangeEnd),
  ...
  function convertResponseList(Data) {
    return Data.map((item, index) => ({
      ...
      weightage: item.responseWeightage || rangeEnd,
  ...
  const handleAddRow = () => {
    console.log(formik.values.responses);
    console.log(surevyData);
  ...
  const handleDeleteRow = (index) => {
    if (formik.values.responses.length > 1) {
      ...
      const updateResponses = newResponses.reverse().map((item, i) => {
              ...
              {formik.values.responses.map((response, index) => (
                ...
                >
                  <div className="scalarappend_list d-flex justify-content-between gap-2 align-items-center">
                    <div className="sequence d-flex d-flex align-items-center">
...
export default SingleRatingJumpQuestionDA;
