...
// i have passing searchValue as empty string because
...
export default function Active({
  ...
  // Replace pagination and sorting states with tableState
              ...
              <li className="list-inline-item">
                <Dropdown>
                  ...
                  <Dropdown.Menu>
                    ...
                    <Dropdown.Item href="#!"  onClick={() => {setSelectedActiveSurveyId(row?.survey_id); scheduleShow()}}>
                    ...
                    <Dropdown.Item href="#!">
                      <Link onClick={() => handleSaveResourceSetup(row)}>
                        {" "}
                        <em className="icon-resources" />
                        Save to Resources{" "}
                      </Link>
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => handlePause(row)}>
    ...
    <>
      <div className="d-flex justify-content-end mb-3">
        {/* <Link className="btn-icon ripple-effect check-button">
          <CsvDownloader
            filename="Manage_surveys_active"
            extension=".csv"
