...
export const validationCreateFromExisting = () => {
  return yup.object().shape({
    ...
    selectedSurveyId: yup.string().required('From Assessment Name is required'),
    newSurveyName: yup.string().required('To Assessment Name is required'),
    selectionConfirm: yup.boolean().optional('Copy and edit selection is required'),
  });
};


export const validationCreateFromExistingResource = () => {
  return yup.object().shape({
    fromCompanyID: yup.string().required('From Company Name is required'),
    toCompanyID: yup.string().required('To Company Name is required'),
