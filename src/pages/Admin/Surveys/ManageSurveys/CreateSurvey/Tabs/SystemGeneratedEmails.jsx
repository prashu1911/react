...
const SystemGeneratedEmails = ({ userData, companyID }, ref) => {
  ...
  const [copyDefaultLoader, setCopyDefaultLoader] = useState(false);
        ...
        <Accordion>
            ...
            <Accordion.Body>
              <div className="d-flex justify-content-between flex-wrap mb-md-3 mb-2">
                ...
                <Link
                  ...
                  onClick={() => handleCopyComment("PreStart")}
                >
                  <OverlayTrigger
                    overlay={
                      <Tooltip id="tooltip-disabled">
                        Copy From Email Templates in Default Settings
                      </Tooltip>
                    }
                  >
                  ...
                  {copyDefaultLoader ? "Copying...." : "Copy Default Settings"}
                </Link>

                {/* Link to search and add from resource */}
                <Link
                  className="link-primary d-flex align-items-center lh-1"
                  onClick={() => emailShow("Pre-Start")}
                >
                  <OverlayTrigger
                    overlay={
                      <Tooltip id="tooltip-disabled">
          ...
          <Accordion.Item eventKey="1" id="acc-assignEmail">
            ...
            <Accordion.Body>
              <div className="d-flex justify-content-between flex-wrap mb-md-3 mb-2">
                <Link
                  className="link-primary d-flex align-items-center lh-1"
                  onClick={() => handleCopyComment("Assign")}
                >
                  {copyDefaultLoader ? "Copying...." : "Copy Default Settings"}
                </Link>
                <Link
                  className="link-primary d-flex align-items-center lh-1"
                  onClick={() => emailShow("Assign")}
                >
                  <OverlayTrigger
                    overlay={
                      <Tooltip id="tooltip-disabled">
          ...
          <Accordion.Item eventKey="2" id="acc-reminderEmail">
            ...
            <Accordion.Body>
              <div className="d-flex justify-content-between flex-wrap mb-md-3 mb-2">
                <Link
                  className="link-primary d-flex align-items-center lh-1"
                  onClick={() => handleCopyComment("Reminder")}
                >
                  {copyDefaultLoader ? "Copying...." : "Copy Default Settings"}
                </Link>
                <Link
                  className="link-primary d-flex align-items-center lh-1"
                  onClick={() => emailShow("Reminder")}
                >
                  <OverlayTrigger
                    overlay={
                      <Tooltip id="tooltip-disabled">
          ...
          <Accordion.Item eventKey="3" id="acc-thanksEmail">
            ...
            <Accordion.Body>
              <div className="d-flex justify-content-between flex-wrap mb-md-3 mb-2">
                <Link
                  className="link-primary d-flex align-items-center mb-2 lh-1"
                  onClick={() => handleCopyComment("Thank You")}
                >
                  {copyDefaultLoader ? "Copying...." : "Copy Default Settings"}
                </Link>
                <Link
                  className="link-primary d-flex align-items-center mb-2 lh-1"
                  onClick={() => emailShow("Thank You")}isOverRide
                >
                  <OverlayTrigger
                    overlay={
                      <Tooltip id="tooltip-disabled">
