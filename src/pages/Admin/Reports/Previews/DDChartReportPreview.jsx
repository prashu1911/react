...
function DDChartReportPreview() {
  ...
  const fetchChartOptions = async (action) => {
    try {
      ...
      if (response?.status) {
        ...
        console.log(filteredChartOptions,"charttype")
  ...
  useEffect(() => {
    if (chartSettings && chartSettings?.key !== "dd-chart-report-preview") {
        ...
        <div className="summaryReport">
          ...
          <div className="pageTitle d-flex justify-content-between align-items-center gap-2">
              <div className="d-flex align-items-center">
                <h2 className="mb-0">Drilldown Report Preview</h2>
              </div>
            ...
            <Comments comment={comment.opening} userData={userData} image ={true} reportName={reportName}/>
              ...
              {chartSettings?.Data?.chartOptions.showCrosstab&&<div className="reportCard">
                                <Previewboxheader userData={userData} image ={true} reportName={reportName}/>
...
export default DDChartReportPreview;
