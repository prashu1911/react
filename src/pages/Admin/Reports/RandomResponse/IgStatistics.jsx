...
import { InputField, ModalComponent, ReactDataTable, SelectField,  SweetAlert } from '../../../../components';
import SummaryData from './json/SummaryData.json';
import { statusFormatter } from '../../../../components/DataTable/TableFormatter';
import { useTable } from "../../../../customHooks/useTable";

export default function IgStatistics({editModalShow}) {
    ...
    const columns = [
        ...
        {   
            ...
            dataKey:"name",
            data:"name",
            columnHeaderClassName:"w-50",
            columnClassName:"align-top w-50",      
        ...
        {   
            ...
            dataKey:"date",
            data:"date",
            columnHeaderClassName:"w-1 w-25",
            columnClassName:"align-top w-25",
