...
import { departmentOptions, participantOptions, managerOptions, genderOptions, ageOptions, tenureOptions, locationOptions, roleOptions, benchmarkOptions, savedOptions } from "./CollapseFilterOptions/CommonSelectFieldOptions";

export default function Outcomes() {

  // collapse
  const [outcomesCollapse, setOutcomesCollapse] = useState(null);
  const outcomesToggleCollapse = (collapseId) => {
      setOutcomesCollapse(outcomesCollapse === collapseId ? null : collapseId);
  };
  ...
  return (
    ...
    <div className="d-flex align-items-center justify-content-between flex-wrap mb-4 gap-2">
      <ul className="collapseList list-inline d-flex align-items-center gap-2 mb-0 pb-lg-0 pb-1 collapseBtn">
        <li>
          <Link href="#!" aria-controls="aggregateFilter" onClick={() => outcomesToggleCollapse('aggregateFilter')} aria-expanded={outcomesCollapse === 'aggregateFilter'} className="btn btn-light gap-2 collapseArrow">
            <span>Filter</span>
            <em className="icon icon-drop-down" />
          </Link>
        </li>
        <li>
          <Link href="#!" aria-controls="quickCompare" onClick={() => outcomesToggleCollapse('quickCompare')} aria-expanded={outcomesCollapse === 'quickCompare'} className="btn btn-light gap-2 collapseArrow">
            <span>Quick Compare</span>
            <em className="icon icon-drop-down" />
          </Link>
        </li>
        <li>
          <Link href="#!" aria-controls="composite" onClick={() => outcomesToggleCollapse('composite')} aria-expanded={outcomesCollapse === 'composite'} className="btn btn-light gap-2 collapseArrow">
            <span>Composite</span>
            <em className="icon icon-drop-down" />
          </Link>
        </li>
        <li>
          <Link href="#!" aria-controls="referenceData" onClick={() => outcomesToggleCollapse('referenceData')} aria-expanded={outcomesCollapse === 'referenceData'} className="btn btn-light gap-2 collapseArrow">
            <span>Reference Data</span>
            <em className="icon icon-drop-down" />
          </Link>
        </li>
        <li>
          <Link href="#!" aria-controls="reports" onClick={() => outcomesToggleCollapse('reports')} aria-expanded={outcomesCollapse === 'reports'} className="btn btn-light gap-2 collapseArrow">
            <span>Reports</span>
            <em className="icon icon-drop-down" />
          </Link>
        </li>
      ...
      <ul className="list-inline d-flex align-items-center filter_action mb-0 flex-wrap collapseBtn">
        <li>
          <Link href="#!" aria-controls="chartOptions" onClick={() => outcomesToggleCollapse('chartOptions')} aria-expanded={outcomesCollapse === 'chartOptions'} className="btn btn-light gap-2 bg-toggleSky">
    ...
    <Collapse in={outcomesCollapse === 'composite'}>
        <Form>
          <div className="formCard">
            <Row className="gx-2">
                <CommonSelectField
    ...
    <Collapse in={outcomesCollapse === 'referenceData'}>
      <Form>
