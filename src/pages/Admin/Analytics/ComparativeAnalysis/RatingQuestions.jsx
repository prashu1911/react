...
import { departmentOptions, participantOptions, managerOptions, genderOptions, ageOptions, tenureOptions, locationOptions, roleOptions, outcomesOptions, intentionOptions, benchmarkOptions, savedOptions } from "./CollapseFilterOptions/CommonSelectFieldOptions";
...
export default function RatingQuestions() {
  ...
  return (
    ...
    <ul className="collapseList list-inline d-flex align-items-center gap-2 mb-0 pb-lg-0 pb-1 collapseBtn">
      <li>
        <Link href="#!" aria-controls="aggregateFilter" onClick={() => ratingToggleCollapse('aggregateFilter')} aria-expanded={rattingCollapse === 'aggregateFilter'} className="btn btn-light gap-2 collapseArrow">
          <span>Filter</span>
          <em className="icon icon-drop-down" />
        </Link>
      </li>
      <li>
        <Link href="#!" aria-controls="quickCompare" onClick={() => ratingToggleCollapse('quickCompare')} aria-expanded={rattingCollapse === 'quickCompare'} className="btn btn-light gap-2 collapseArrow">
          <span>Quick Compare</span>
          <em className="icon icon-drop-down" />
        </Link>
      </li>
      <li>
        <Link href="#!" aria-controls="composite" onClick={() => ratingToggleCollapse('composite')} aria-expanded={rattingCollapse === 'composite'} className="btn btn-light gap-2 collapseArrow">
          <span>Composite</span>
          <em className="icon icon-drop-down" />
        </Link>
      </li>
      <li>
        <Link href="#!" aria-controls="referenceData" onClick={() => ratingToggleCollapse('referenceData')} aria-expanded={rattingCollapse === 'referenceData'} className="btn btn-light gap-2 collapseArrow">
          <span>Reference Data</span>
          <em className="icon icon-drop-down" />
        </Link>
      </li>
      <li>
        <Link href="#!" aria-controls="reports" onClick={() => ratingToggleCollapse('reports')} aria-expanded={rattingCollapse === 'reports'} className="btn btn-light gap-2 collapseArrow">
          <span>Reports</span>
          <em className="icon icon-drop-down" />
        </Link>
      </li>
    ...
    <ul className="list-inline d-flex align-items-center filter_action mb-0 flex-wrap collapseBtn">
      <li>
        <Link href="#!" aria-controls="chartOptions" onClick={() => ratingToggleCollapse('chartOptions')} aria-expanded={rattingCollapse === 'chartOptions'} className="btn btn-light gap-2 bg-toggleSky">
    ...
    <Collapse in={rattingCollapse === 'composite'}>
        <Form>
          <div className="formCard">
            <Row className="gx-2">
                <CommonSelectField
    ...
    <Collapse in={rattingCollapse === 'referenceData'}>
        <Form>
