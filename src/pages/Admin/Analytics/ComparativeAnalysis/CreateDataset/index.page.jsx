...
import { Button, Breadcrumb, DataTableComponent, InputField, SelectField, SweetAlert } from '../../../../../components';
import adminRouteMap from "../../../../../routes/Admin/adminRouteMap";
import CreateDatasetData from './CreateDatasetData.json';
        ...
        <>
            ...
            <div className="pageContent">
                <div className="pageTitle d-flex align-items-center">
                    ...
                    <h2 className='mb-0'>Create Dataset</h2>
                </div>
                <Form>
                    <div className="pageTitle pt-lg-2">
                        <h2>1. Enter a file name for your combined dataset</h2>
                    </div>
                    <Row className="pt-lg-1">
                        <Col lg={4}>
                            <Form.Group className="form-group">
                                <Form.Label>Enter a file name for your comparison dataset <sup>*</sup></Form.Label>
                                <InputField type="text" placeholder="--Enter Dataset Name--" />
                            </Form.Group>
                        </Col>
                    </Row>
                ...
                <DataTableComponent showFooter={false} data={CreateDatasetData} columns={columns}  />
